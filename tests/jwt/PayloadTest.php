...
use Mockery;
use tp5er\think\auth\jwt\claims\Audience;
...
class PayloadTest extends AbstractTestCase
{
    ...
    /**
     * @test
     * @expectedException \tp5er\think\auth\jwt\exceptions\PayloadException
