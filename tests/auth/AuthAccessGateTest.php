...
use tp5er\think\auth\access\HandlesAuthorization;
...
class AuthAccessGateTest extends TestCase
{
    ...
    /**
     * @var \Closure|App|\think\Container
     */
    protected $app;
    ...
    {
        unset($_SERVER['__thinkphp.testBefore']);
        ...
        $this->assertTrue($_SERVER['__thinkphp.testBefore']);
    ...
    {
        $_SERVER['__thinkphp.testBefore'] = false;
        ...
        $this->assertTrue($gate->check('edit', new AccessGateTestDummy));
        $this->assertFalse($gate->check('update', new AccessGateTestDummy));
        $this->assertFalse($_SERVER['__thinkphp.testBefore']);
    ...
    {
        $_SERVER['__thinkphp.gateBefore'] = false;
        $_SERVER['__thinkphp.gateBefore2'] = false;
        $_SERVER['__thinkphp.gateAfter'] = false;
        $_SERVER['__thinkphp.gateAfter2'] = false;
        ...
        $gate->before(function (?stdClass $user) {
            $_SERVER['__thinkphp.gateBefore'] = true;
        });

        $gate->after(function (?stdClass $user) {
            $_SERVER['__thinkphp.gateAfter'] = true;
        });

        $gate->before(function (stdClass $user) {
            $_SERVER['__thinkphp.gateBefore2'] = true;
        });

        $gate->after(function (stdClass $user) {
            $_SERVER['__thinkphp.gateAfter2'] = true;
        });
        ...
        $this->assertTrue($_SERVER['__thinkphp.gateBefore']);
        $this->assertFalse($_SERVER['__thinkphp.gateBefore2']);
        $this->assertTrue($_SERVER['__thinkphp.gateAfter']);
        $this->assertFalse($_SERVER['__thinkphp.gateAfter2']);

        unset(
            $_SERVER['__thinkphp.gateBefore'],
            $_SERVER['__thinkphp.gateBefore2'],
            $_SERVER['__thinkphp.gateAfter'],
            $_SERVER['__thinkphp.gateAfter2']
        );
    }
...
class AccessGateTestPolicyThatAllowsGuests
{
    ...
    {
        $_SERVER['__thinkphp.testBefore'] = true;
    }
